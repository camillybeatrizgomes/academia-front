...
export const notifySuccess = (mensagem) => toast.success(mensagem, { position: toast.POSITION.TOP_RIGHT });

export const notifyError = (mensagem) => toast.error(mensagem, { position: toast.POSITION.TOP_RIGHT });
